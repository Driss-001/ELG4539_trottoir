...
sont espacées de d = 15cm et donc la vitesse revient à diviser la différence de position multipliée par d, N étant lentier lu par1:
...
\begin{figure}[htbp]
    \centerline{\includegraphics[scale = 0.2]{react_dashboard.PNG}}
